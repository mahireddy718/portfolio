...
const ProjectsSection = () => {
  const projects = [
    {
      title: 'FreelanceCo',
      description: 'A freelancing platform and marketplace where users can discover and hire talented professionals across various categories like web development, digital marketing, and design. Features an intuitive dashboard, modern UI, and seamless project management.',
      image: '',
      tags: ['React', 'Tailwind CSS', 'Node.js', 'Express', 'MongoDB'],
      links: {
        github: 'https://github.com/mahireddy718/FreelanceCo',
        live: 'https://freelanceco-six.vercel.app/'
      }
    },
    {
