    ...
    <section id="about" className="about-section section">
      ...
      >
        ...
        <motion.div className="about-action" variants={textVariants}>
          <a href="https://drive.google.com/file/d/1Xmvp-vZFEcb1GQHuYQ7We_0BjV_f1D0A/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="btn btn-outline">View Resume</a>
        </motion.div>
      </motion.div>
    </section>
  );
